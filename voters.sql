...
CREATE TABLE ncvoter11 (
    ...
    absent_ind char   NOT NULL,
    name_prefx_cd char   NOT NULL,
    ...
    municipality_desc varchar   NOT NULL,
    ward_abbrv varchar   NOT NULL,
    ward_desc varchar   NOT NULL,
    ...
    county_commiss_desc varchar   NOT NULL,
    township_abbrv varchar   NOT NULL,
    township_desc varchar   NOT NULL,
    school_dist_abbrv varchar   NOT NULL,
    school_dist_desc varchar   NOT NULL,
    fire_dist_abbrv varchar   NOT NULL,
    fire_dist_desc varchar   NOT NULL,
    water_dist_abbrv varchar   NOT NULL,
    water_dist_desc varchar   NOT NULL,
    sewer_dist_abbrv varchar   NOT NULL,
    sewer_dist_desc varchar   NOT NULL,
    sanit_dist_abbrv varchar   NOT NULL,
    sanit_dist_desc varchar   NOT NULL,
    rescue_dist_abbrv varchar   NOT NULL,
    rescue_dist_desc varchar   NOT NULL,
    munic_dist_abbrv varchar   NOT NULL,
    munic_dist_desc varchar   NOT NULL,
    dist_1_abbrv varchar   NOT NULL,
    dist_1_desc varchar   NOT NULL,
    dist_2_abbrv varchar   NOT NULL,
    dist_2_desc varchar   NOT NULL,
